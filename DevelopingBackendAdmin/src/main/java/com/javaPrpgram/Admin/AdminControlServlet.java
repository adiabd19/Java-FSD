...
import com.javaProgram.models.Class;
import com.javaProgram.models.Student;
import com.javaProgram.models.Subject;
import com.javaProgram.models.Teacher;

/**
 * Servlet implementation class AdimControlServlet
 */
@WebServlet("/AdimnControlServlet")
public class AdminControlServlet extends HttpServlet {
	...
	private void teachersList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// send it to the jSP view page
		RequestDispatcher dispatcher = request.getRequestDispatcher("/teacher-lists.jsp");
		dispatcher.forward(request, response);
	...
	private void subjectList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// send it to the jSP view page
		RequestDispatcher dispatcher = request.getRequestDispatcher("/subjects-lists.jsp");
		dispatcher.forward(request, response);
